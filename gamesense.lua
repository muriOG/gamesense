...
local Window = OrionLib:MakeWindow({Name = "Gamesense Private", HidePremium = true, SaveConfig = true, ConfigFolder = "gamesense"})
...
AimTab:AddToggle({
	...
	Callback = function(Value)
        ...
        if getgenv().sile_loaded == false and Value == true then
            ...
            loadstring(game:HttpGet("https://raw.githubusercontent.com/muriOG/gamesense/main/silentaim", true))()
        end
	end    
})
